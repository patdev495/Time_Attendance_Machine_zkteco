# We redirect all output inside the script to a file
$clientPath = "C:\Program Files (x86)\Hanvon\FaceAtt\Client"
$outputPath = Join-Path "D:\Workspace\Time_Attendance_Machine\research_hanvon_sdk" "decompile_business.txt"

# Clear previous output
if (Test-Path $outputPath) { Remove-Item $outputPath }

# We wrap everything in a script block that we pipe to Out-File
& {
