...
public class ExecuteCommandDumper
{
    public static void Main()
    {
        ...
        MethodInfo method = type.GetMethod("ExecuteCommand", BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Static);
        if (method == null)
        {
            Console.WriteLine("Method ExecuteCommand not found");
            return;
        }

        Console.WriteLine("=== Disassembling DeviceOperation.ExecuteCommand ===");
        DumpMethod(method);
    }
